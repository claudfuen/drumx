...
| Practice | Default 16 bars; collapsed Practice options; 1/4/8/16/32-bar choices; slower/retry/repair actions and comparable-take results | The shared tempo range and 32-bar option still differ. The restored review hierarchy needs final on-screen inspection. |
