...
- **Experience bar:** a small, finished game that could credibly be sold on Steam, while free distribution remains the goal. Inspect the entire launch/setup/select/play/review/return flow for cohesive visuals and audio, clear language, satisfying response, accessible feedback, empty states, and graceful interruptions. Store availability is not part of this claim.
